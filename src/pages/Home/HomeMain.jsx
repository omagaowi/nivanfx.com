    ...
    const scrollMatch = () => {
        if(window.location.href.split('/')[3] == ''){
            ...
            if(scrollPosition >= nintyPercent){
              ...
              navbarRef.current.querySelector(".logo img").src = "/src/assets/logo.png";
            }else{
             navbarRef.current.classList.remove("white");
             navbarRef.current.querySelector(".logo img").src = "/src/assets/logo2.png";
            }
        }
    }
    useEffect(()=>{
    ...
    return (
        <div className="home-main" ref={ homeMainRef }>
           ...
           <div className="full-body">
                <div className="body-part part1" ref={ firstRef }></div>
